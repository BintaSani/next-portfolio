            ...
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
              ...
              >
                ...
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                  ...
                  passion for learning and innovating. I also love baking and
                  Photography.
                </p>
                <motion.a
                  whileTap={{ scale: 0.8 }}
                ...
                <div class=" items-center py-8 px-4 mx-auto max-w-screen-xl md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                  ...
                  >
                    ...
                    <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                      Greetings! I'm Binta Sani, a passionate Frontend developer
                      who thrives on hard work and dedication. My days are often
                      filled with writing impressive React apps. When I'm not
                      engrossed in coding, you'll find me researching the latest
                      industry trends or baking.
                    </p>
                  </motion.div>
                </div>
              </motion.section>
