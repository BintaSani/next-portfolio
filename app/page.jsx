    ...
    <main className="scroll-smooth flex flex-col items-center justify-between py-5 bg-white dark:bg-gray-900">
      ...
      animate={inView ? { opacity: 1 } : {}} id="projects" className="py-8 px-6 min-h-screen mb-[33px] lg:mx-[119px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-6 py-8 mx-auto">
          <Cards view="https://bills-pi.vercel.app/" first="Next.js" second="Tailwind css" third="PWA" src="/images/bills.webp" head="Bills" content="Bills is an all round bill payment progressive web app (PWA) where all utility bills and phone bills are processed through Paga."/>
          <Cards view="https://bills-admin.vercel.app/" first="Next.js" second="Tailwind css" third="Chart.js" src="/images/bills-admin.webp" head="BillEase+" content="BillEase+ is an Administration management platform where the data for Bills PWA is collected, sorted and stored."/>
          <Cards view="https://crownstores.netlify.app/" first="React" second="Styled-Components" third="Firebase" src="/images/project1.webp" head="Crown Store" content="Crown Stores is an e-commerce website developed with React.js which offers simple authentication through Firebase and secure payment processing via Stripe."/>
          ...
          <Cards view="https://hng-task3.netlify.app/" first="React" second="Firebase" third="SCSS" src="/images/project3.webp" head="Image Gallery" content="Image Gallery is a user-friendly image gallery where images can be rearranged simply by dragging and dropping images in the desired position."/>
          <Cards view="https://moviesitetask.netlify.app/" first="React" second="Scss" third="TMDB Api" src="/images/project4.webp" head="Movie Box" content="MovieBox is an interactive movie website which offers users the opportunity to explore the top 10 rated movies along with a search functionality to discover specific movies of interest."/>
        </div>
      </motion.section>
      )}
      </InView>
