    ...
    <main className="scroll-smooth flex flex-col items-center justify-between py-5 bg-white dark:bg-gray-900">
      ...
      <section id="hero" class="bg-white dark:bg-gray-900 mb-9 xl:h-[90vh] " style={{display: loading ? 'none' : 'flex'}}>
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            ...
            transition={{ duration: 1 }} class="mr-auto place-self-center lg:col-span-7">
                ...
                <motion.a whileTap={{ scale: 0.8 }} href="https://drive.google.com/uc?export=download&id=1PiGeq23gkQp23RO1sGAbuvbGr8goMAqx" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                    Download Cv
                </motion.a> 
            </motion.div>
      ...
      animate={inView ? { opacity: 1 } : {}} id="projects" className="py-8 px-6 min-h-screen mb-[33px] lg:mx-[119px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-6 py-8 mx-auto">
          ...
          <Cards view="https://crownstores.vercel.app/" first="React" second="Styled-Components" third="Redux" src="/images/project1.webp" head="Crown Store" content="Crown Stores is a modern e-commerce website built with React.js which offers simple authentication wth Firebase and secure payment processing via Stripe."/>
