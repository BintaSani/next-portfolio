...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-between py-5 bg-white dark:bg-gray-900">
      ...
      <section className="py-8 px-6 min-h-screen mb-[33px] lg:mx-[119px]">
                ...
                <div class="lg:w-1/2 lg:mx-6">
                    ...
                    <div class="mt-6 space-y-8 md:mt-8">
                        <p class="flex items-start -mx-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-blue-500 dark:text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="mt-6 w-80 md:mt-8">
                        ...
                        <div class="flex mt-4 -mx-1.5 ">
                            ...
                            <a class="mx-1.5 dark:hover:text-gray-800 text-gray-400 transition-colors duration-300 transform hover:text-gray-700" href="#">
